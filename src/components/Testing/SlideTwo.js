...
function SlideTwo({TestAnswers,setTestanswers}){
  ...
  //"/Testing/Test2_No_Tumor.jpg"
  return(
  <div>
      <div className="Container">
          <div className="row justify-content-around py-4">
            <div className="col-sm-6 col-md-6 col-lg-5 col-xxl-6 col-xl-5">
              <img src="/Testing/Test2_No_Tumor.jpg"  alt="tumor" className="card-img-size img-fluid" ></img>
            ...
            <div className="col-sm-6 col-md-6 col-lg-5 col-xxl-6 col-xl-5">
              <img src="/Testing/Test2_Tumor.jpg" alt="no tumor" className="card-img-size img-fluid" ></img>
              <div className="d-flex justify-content-center my-5">
